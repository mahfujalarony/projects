...
const { register, login, googleLogin, getMyBalance , pendingMerchants, approveOrRejectMerchant, getMerchantUsers, getRejectedMerchants,  addAddress, getCurrentUserAddresses, getMyProfile, updateMyProfileImage, getPublicUserProfileById, getPublicUsersBatch } = require('../controllers/authController');
