          ...
          {!loading && rows.length === 0 ? (
            ...
            <div key={r.id} className="rounded-xl border border-gray-200 bg-white p-3 shadow-sm hover:shadow-md transition-shadow">
              <div className="flex items-start gap-3">
                {r.imageUrl
                  ? <img src={r.imageUrl} alt={r.name} className="h-11 w-11 shrink-0 rounded-lg border object-cover" />
          ...
          <div className="space-y-3 text-sm max-w-lg mx-auto">
            <div className="flex items-center gap-3 rounded-xl border border-gray-100 bg-gray-50 p-3">
              {selectedOrder.imageUrl
                ? <img src={selectedOrder.imageUrl} alt={selectedOrder.name} className="h-14 w-14 shrink-0 rounded-lg border object-cover" />
